  ...
  return (
    <section id="abt-us" className="py-20 hero-pattern">
      <div className="container mx-auto px-4">
        <h2
          className="text-4xl font-bold text-center text-white mb-12 glowing-border"
          data-aos="fade-up"
        >
          Nuestro Equipo
        </h2>
        ...
        >
          <p className="mb-4">
            En nuestro equipo desarrollamos soluciones digitales que combinan
            funcionalidad, diseño y tecnología moderna. Nos especializamos en
            crear aplicaciones web completas: flexibles, escalables y hechas a
            la medida de cada proyecto, sin importar si comienza como una simple
            idea o un sistema complejo.
          </p>
          <p>
            Cada proyecto refleja nuestra pasión por la innovación, la
            automatización y la construcción de software que realmente funciona
